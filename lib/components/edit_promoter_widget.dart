...
import 'edit_promoter_model.dart';
export 'edit_promoter_model.dart';

class EditPromoterWidget extends StatefulWidget {
  const EditPromoterWidget({
    Key? key,
    this.user,
  }) : super(key: key);
  ...
  @override
  _EditPromoterWidgetState createState() => _EditPromoterWidgetState();
}

class _EditPromoterWidgetState extends State<EditPromoterWidget>
    with TickerProviderStateMixin {
  late EditPromoterModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditPromoterModel());
